    ...
    document.getElementById("box-flex").innerHTML =
        `
                <div class="box-flex-1">
                    <div>
                        <img class="in-image" src="assets/Bara.jpg" />
                        <div class="content">
                            <a class="judul" href="detailProject.html" style="text-decoration: none; color: black;">
                                <p>Dumbway Mobile App - 2021</p>
                            </a>
                            <p>Durasi- 3 bulan</p>
                ...
                <div class="box-flex-1">
                    <div>
                        <img class="in-image" src="assets/Anti mage.png" />
                        <div class="content">
                            <a class="judul" href="detailProject.html" style="text-decoration: none; color: black;">
                                <p>Dumbway Mobile App - 2021</p>
                            </a>
                ...
                <div class="box-flex-1">
                    <div>
                        <img class="in-image" src="assets/Jahrakal.jpg" />
                        <div class="content">
                            <a class="judul" href="detailProject.html" style="text-decoration: none; color: black;">
                                <p>Dumbway Mobile App - 2021</p>
                            </a>
                ...
                <div class="box-flex-1">
                    <div>
                        <img class="in-image" src="assets/MDAXKY.jpg" />
                        <div class="content">
                            <a class="judul" href="detailProject.html" style="text-decoration: none; color: black;">
                                <p>Dumbway Mobile App - 2021</p>
                            </a>
                ...
                <div class="box-flex-1">
                    <div>
                        <img class="in-image" src="assets/WraithKingArcana.jpg" />
                        <div class="content">
                            <a class="judul" href="detailProject.html" style="text-decoration: none; color: black;">
                                <p>Dumbway Mobile App - 2021</p>
                            </a>
